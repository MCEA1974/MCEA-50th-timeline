...
class Timeline {
    ...
    _initLayout() {
        ...
        if (this.options.timenav_position == "top") {
          ...
          // Custom Logo for MCEA
        this._el.attribution = DOM.create('div', 'tl-attribution', this._el.container);
        this._el.attribution.innerHTML = "<a href='https://www.mncenter.org' target='_blank' rel='noopener'><img src='https://www.mncenter.org/sites/default/files/logo/GREEN%20horz%20full%20write%20out.png' alt='MCEA Logo' style='height: 20px;'></a>";
